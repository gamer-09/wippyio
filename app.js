...
(function () {
  ...
  function cardHTML(p, index) {
    ...
    const ghLink = p.githubUrl
      ? `<a class="card-gh" href="${escapeAttr(p.githubUrl)}" target="_blank" rel="noopener noreferrer" title="View on GitHub" onclick="event.stopPropagation()">
  ...
  function openPopup(p) {
    ...
    if (p.githubUrl) {
      ghHTML = `
        <a class="popup-gh-link" href="${escapeAttr(p.githubUrl)}" target="_blank" rel="noopener noreferrer">
